---
name: gtm-mavericks
description: Use when launching, positioning, repositioning, or running a marketing/GTM campaign for ANY product — new platforms, SaaS products, mobile apps, consumer brands, infrastructure tools, AI products, B2B services, developer tools, durable execution platforms, anything that ships to market. Trigger on phrases like "launch X", "help me launch", "we're building", "go to market", "GTM", "positioning", "ICP", "messaging house", "marketing strategy", "product launch", "reposition", "campaign", "ready to ship", "new product". Runs a multi-phase Conductor workflow with a 6-persona debate panel (Don Draper, Steve Jobs, David Ogilvy, Lee Clow, Gary Halbert, April Dunford) who argue over ICP and positioning, then commit one voice to asset generation (sales playbook, landing copy, ad copy, outbound sequences). Produces ship-ready PDF + markdown with strategic forks preserved. Long-running 30-60 min; resumes conversationally across sessions.
